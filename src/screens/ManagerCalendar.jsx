...
export default function ManagerCalendar({ me, openItem, openProject }) {
  ...
  async function load(){
    ...
    const firstError=[projects.error,work.error,members.error,leave.error].find(Boolean);
  ...
  return <div className="body">
    <div style={{paddingTop:26}}><div className="eyebrow">{me.unit_name}</div><h1 className="h1" style={{marginTop:6}}>Calendar</h1><p className="screen-note">Project dates, task deadlines and approved team leave in one place. Ministry-wide calendar entries are not connected yet.</p></div>
