...
begin
  ...
  if n<>86 then
    raise exception 'Platform Kernel gate failure: expected 86 authenticated SECURITY DEFINER functions after reviewed Stage 8 learning RPCs, found %.',n;
  end if;
