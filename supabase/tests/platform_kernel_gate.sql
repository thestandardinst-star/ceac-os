...
begin
  ...
  if n<>84 then
    raise exception 'Platform Kernel gate failure: expected 84 authenticated SECURITY DEFINER functions after reviewed Stage 7 performance-development RPCs, found %.',n;
  end if;
